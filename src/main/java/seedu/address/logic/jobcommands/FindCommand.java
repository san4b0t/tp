...
/**
 * Finds and lists all job applications in book whose company name contains any of the argument keywords.
...
public class FindCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Finds all job applications whose company names contain any of "
            + "the specified keywords (case-insensitive) and displays them as a list with index numbers.\n"
            + "Parameters: KEYWORD [MORE_KEYWORDS]...\n"
            + "Example: " + COMMAND_WORD + " TikTok Jan Street HRT";
