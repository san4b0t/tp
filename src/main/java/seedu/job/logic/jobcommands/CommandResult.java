...
public class CommandResult {
     ...
     */
    public CommandResult(String feedbackToUser, boolean showHelp, boolean exit, boolean shouldSave) {
    ...
    /**
     * Constructs a {@code CommandResult} with the specified fields, shouldSave set to false.
     */
