...
public class MainWindow extends UiPart<Stage> {
    ...
    private JobApplicationListPanel jobApplicationListPanel;
    ...
    @FXML
    private StackPane jobApplicationListPanelPlaceholder;
     ...
     */
    void fillInnerParts() {
        jobApplicationListPanel = new JobApplicationListPanel(logic.getFilteredApplicationsList());
     ...
     *
     * @see seedu.job.logic.Logic#execute(String)
     */
    private CommandResult executeCommand(String commandText) throws JobCommandException, ParseException {
        try {
